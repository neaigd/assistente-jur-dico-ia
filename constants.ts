...
export const EMAIL_QUERY_TERMS = '"andamento processual" OR "intimação" OR "publicação de despacho" OR "sentença" OR "movimentação processual" OR "diário oficial" OR "prazo"'; // Termos para buscar e-mails jurídicos
